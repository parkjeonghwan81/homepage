...
public class Utility {
	...
	public static String getCodeValue(String code){
		String value=null;
		Hashtable codes = new Hashtable();   //문자열 키가 들어갈수있다면 다른 컬렉션프레임워크 사용 가능
		codes.put("A01", "회사원");   //키에 벨류
		codes.put("A02", "전산관련직");
		codes.put("A03", "연구전문직");
...
//	     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
	   ...
	   for(int i=startPage; i<=endPage; i++){ 
	     if (i > totalPage){    //endPage가 totalPage(실제레코드수)보다 더 큰 경우 빠져나오는 for문. 
	       break;   //빠져나옴
	     } 
